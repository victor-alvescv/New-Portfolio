export const experienceConfig = [
  ...
  },
  {
    ...
    description: [
      "As a valued member of a dynamic web development team, I had the privilege of collaborating with a diverse group of professionals, including UX designers and backend engineers in order to maintain and upgrade a high quality website helping people to improve their looks with technology.",
      "Helped with the Structure(HTML), ensuring a user-friendly layout that facilitates easy navigation and accessibility for all visitors. And design(CSS), shaping the website's visual appeal and user experience.",
      "Used the best practice code and ethic for a better work environment. Overall, my experience working collaboratively with UX designers, backend engineers, and my dedication to employing the best coding practices and ethical standards empowered me to play a crucial role in delivering a high-quality website that genuinely enhances people's lives through technology.",
    ],
